...
struct MemoryPointerRange<T>
{
	lower_inclusive: *mut T,
...
{
	#[inline(always)]
	fn new(lower_inclusive: *mut T, upper_exclusive: *mut T) -> Self
	{
		debug_assert!(lower_inclusive < upper_exclusive, "lower_inclusive is not less than upper_exclusive");
...
//use ::cto_pool::Persistence;
//use ::cto_pool::block_allocator::BlockAllocator;
//use ::cto_pool::block_allocator::Block;




//struct MemoryPointerRangeToBlockAllocator<P: 'static + Persistence>
//{
//	//sorted_array: Vec<(MemoryPointerRange<u8>, Box<Hack<P>>)>,
//
//}
//
//struct Hack<P: 'static + Persistence>
//{
//	//inner: Box<Box<BlockAllocator<Block<P=P>>>>
//}
